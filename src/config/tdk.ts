...
export const DEFAULT_TDK: TdkEntry = {
  title: "HaloLight",
  description: "HaloLight 企业级后台管理系统，为团队提供统一的数据、权限与运营控制中心。",
  keywords: "HaloLight, 后台管理, 仪表盘, 运营",
}
...
export const ROUTE_TDK: Record<string, TdkEntry> = {
  "/": {
    ...
    keywords: "仪表盘, dashboard, 报表, HaloLight",
  },
  "/analytics": {
    title: "数据分析",
    description: "深入了解您的网站流量和用户行为。",
    keywords: "数据分析, 报表, 流量指标, HaloLight",
  },
  "/calendar": {
    title: "日程安排",
  ...
  "/settings/teams": {
    ...
    keywords: "团队, 成员管理, 组织架构, HaloLight",
  },
  "/settings/teams/roles": {
    title: "角色管理",
    description: "创建和管理系统角色，配置角色权限。",
    keywords: "角色管理, 权限配置, RBAC, HaloLight",
  },
  "/users": {
    title: "用户管理",
  ...
  "/login": {
    title: "登录",
    description: "输入账户凭证以访问 HaloLight 后台。",
    keywords: "登录, 认证, HaloLight",
  },
  "/register": {
    title: "注册",
    description: "创建 HaloLight 账号，开始管理您的业务。",
    keywords: "注册, 创建账号, HaloLight",
  },
  "/forgot-password": {
    title: "找回密码",
  ...
  "/terms": {
    title: "服务条款",
    description: "查看 HaloLight 的服务条款、使用协议与权利义务。",
    keywords: "服务条款, 协议, 法律",
  },
  "/privacy": {
    title: "隐私政策",
